...
(function (n, t) {
    ...
    function yr(n, t, i) {
        ...
        if (u.text = n, t)
            for (r in ie) e = t[r] || t.getAttribute && t.getAttribute(r), e && u.setAttribute(r, e);
    ...
    function ou(n, t, r, u) {
        var s, h, c = 20,
            ...
            f = n.nodeType && (i.cssNumber[t] || e !== "px" && +o) && pt.exec(i.css(n, t));
        if (f && f[3] !== e) {
    ...
    function ae(n) {
        var r, f = n.ownerDocument,
            u = n.nodeName,
            t = wi[u];
        return t ? t : (r = f.body.appendChild(f.createElement(u)), t = i.css(r, "display"), r.parentNode.removeChild(r), t === "none" && (t = "block"), wi[u] = t, t)
    }
    ...
    function lu(n, t, r, u, f) {
        for (var e, o, p, a, w, v, h = t.createDocumentFragment(), y = [], l = 0, b = n.length; l < b; l++)
            if (e = n[l], e || e === 0)
                if (it(e) === "object") i.merge(y, e.nodeType ? [e] : e);
                else if (cu.test(e)) {
        ...
        for (h.textContent = "", l = 0; e = y[l++];) {
            ...
            if (w = ft(e), o = s(h.appendChild(e), "script"), w && bi(o), r)
    ...
    function ki(n, t, r, u, f, e) {
        ...
        if (u == null && f == null ? (f = r, u = r = undefined) : f == null && (typeof r == "string" ? (f = u, u = undefined) : (f = u, u = r, r = undefined)), f === !1) f = st;
        else if (!f) return n;
    ...
    function ei(n, t, u) {
        if (!u) {
            r.get(n, t) === undefined && i.event.add(n, t, ot);
            return
        }
        r.set(n, t, !1);
        i.event.add(n, t, {
            ...
            handler: function (n) {
                ...
                if (n.isTrigger & 1 && this[t]) {
                    ...
                    else if (f = b.call(arguments), r.set(this, t, f), o = u(this, t), this[t](), e = r.get(this, t), f !== e || o ? r.set(this, t, !1) : e = {}, f !== e) return n.stopImmediatePropagation(), n.preventDefault(), e.value
    ...
    function yu(n, t) {
        ...
        if (t.nodeType === 1) {
            if (r.hasData(n) && (s = r.access(n), h = r.set(t, s), u = s.events, u)) {
                ...
                h.events = {};
                for (e in u)
                    for (f = 0, c = u[e].length; f < c; f++) i.event.add(t, e, u[e][f])
            }
    ...
    function ht(n, t, f, o) {
        ...
        var a, w, l, v, h, b, c = 0,
            ...
            p = t[0],
            k = u(p);
        if (k || y > 1 && typeof p == "string" && !e.checkClone && de.test(p)) return n.each(function (i) {
            var r = n.eq(i);
            k && (t[0] = p.call(this, i, r.html()));
            ht(r, t, f, o)
        });
        if (y && (a = lu(t, n[0].ownerDocument, !1, n, o), w = a.firstChild, a.childNodes.length === 1 && (a = w), w || o)) {
            for (l = i.map(s(a, "script"), no), v = l.length; c < y; c++) h = a, c !== d && (h = i.clone(h, !0, !0), v && i.merge(l, s(h, "script"))), f.call(n[c], h, c);
            if (v)
                for (b = l[l.length - 1].ownerDocument, i.map(l, to), c = 0; c < v; c++) h = l[c], hu.test(h.type || "") && !r.access(h, "globalEval") && i.contains(b, h) && (h.src && (h.type || "").toLowerCase() !== "module" ? i._evalUrl && !h.noModule && i._evalUrl(h.src, {
                    nonce: h.nonce || h.getAttribute("nonce")
                }) : yr(h.textContent.replace(ge, ""), h, b))
        }
        return n
    }
    ...
    function pu(n, t, r) {
        for (var u, e = t ? i.filter(t, n) : n, f = 0;
            (u = e[f]) != null; f++) r || u.nodeType !== 1 || i.cleanData(s(u)), u.parentNode && (r && ft(u) && bi(s(u, "script")), u.parentNode.removeChild(u));
        return n
    }

    function dt(n, t, r) {
        var o, s, h, u, f = n.style;
        return r = r || oi(n), r && (u = r.getPropertyValue(t) || r[t], u !== "" || ft(n) || (u = i.style(n, t)), !e.pixelBoxStyles() && di.test(u) && ro.test(t) && (o = f.width, s = f.minWidth, h = f.maxWidth, f.minWidth = f.maxWidth = f.width = u, u = r.width, f.width = o, f.minWidth = s, f.maxWidth = h)), u !== undefined ? u + "" : u
    }
    ...
    function uo(n) {
        for (var i = n[0].toUpperCase() + n.slice(1), t = bu.length; t--;)
            if (n = bu[t] + i, n in ku) return n
    }

    function gi(n) {
        var t = i.cssProps[n] || du[n];
        return t ? t : n in ku ? n : du[n] = uo(n) || n
    }
    ...
    function nr(n, t, r, u, f, e) {
        ...
        for (; o < 4; o += 2) r === "margin" && (s += i.css(n, r + w[o], !0, f)), u ? (r === "content" && (s -= i.css(n, "padding" + w[o], !0, f)), r !== "margin" && (s -= i.css(n, "border" + w[o] + "Width", !0, f))) : (s += i.css(n, "padding" + w[o], !0, f), r !== "padding" ? s += i.css(n, "border" + w[o] + "Width", !0, f) : h += i.css(n, "border" + w[o] + "Width", !0, f));
    ...
    function rf(n, t, r) {
        ...
        return (!e.boxSizingReliable() && o || u === "auto" || !parseFloat(u) && i.css(n, "display", !1, f) === "inline") && n.getClientRects().length && (o = i.css(n, "boxSizing", !1, f) === "border-box", s = h in n, s && (u = n[h])), u = parseFloat(u) || 0, u + nr(n, t, r || (o ? "border" : "content"), s, f, u) + "px"
    }
    ...
    function oo(n, t, u) {
        ...
        for (f in t)
            ...
            k && n.nodeType === 1 && (u.overflow = [h.overflow, h.overflowX, h.overflowY], o = e && e.display, o == null && (o = r.get(n, "display")), l = i.css(n, "display"), l === "none" && (o ? l = o : (et([n], !0), o = n.style.display || o, l = i.css(n, "display"), et([n]))), (l === "inline" || l === "inline-block" && o != null) && i.css(n, "float") === "none" && (s || (v.done(function () {
                h.display = o
            ...
            })), s = of (a ? e[f] : 0, f, v), f in e || (e[f] = s.start, a && (s.end = s.start, s.start = 0))
        }
    }
    ...
    function v(n, t, r) {
        var o, s, h = 0,
            ...
            l = function () {
                if (s) return !1;
                for (var o = ct || ef(), t = Math.max(0, f.startTime + f.duration - o), h = t / f.duration || 0, i = 1 - h, r = 0, u = f.tweens.length; r < u; r++) f.tweens[r].run(i);
            ...
            c = f.props;
        for (so(c, f.opts.specialEasing); h < a; h++)
            if (o = v.prefilters[h].call(f, n, c, f.opts), o) return u(o.stop) && (i._queueHooks(f.elem, f.opts.queue).stop = o.stop.bind(o)), o;
        return i.map(c, of , f), u(f.opts.start) && f.opts.start.call(n, f), f.progress(f.opts.progress).done(f.opts.done, f.opts.complete).fail(f.opts.fail).always(f.opts.always), i.fx.timer(i.extend(l, {
            elem: n,
            anim: f,
            queue: f.opts.queue
        })), f
    ...
    function er(n, t, r, u) {
        ...
        if (Array.isArray(t)) i.each(t, function (t, i) {
            r || ho.test(n) ? u(n, i) : er(n + "[" + (typeof i == "object" && i != null ? t : "") + "]", i, r, u)
        });
        else if (r || it(t) !== "object") u(n, t);
        else
            for (f in t) er(n + "[" + f + "]", t[f], r, u)
    }
    ...
    var d = [],
        ...
        re = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
        k, vi, kr, dr, gr, nu, tu, a, uu, ui, vt, bt, pi, wi, cu, ct, si, uf, ff, sf, lt, hf, cf, lf, rr, ur, kf, at, cr, ci, df, gf;
    i.fn = i.prototype = {
        jquery: pr,
        constructor: i,
        length: 0,
    ...
    i.extend({
        ...
        isPlainObject: function (n) {
            var t, i;
            return !n || ar.call(n) !== "[object Object]" ? !1 : (t = ne(n), !t) ? !0 : (i = ii.call(t, "constructor") && t.constructor, typeof i == "function" && vr.call(i) === te)
        },
    ...
    typeof Symbol == "function" && (i.fn[Symbol.iterator] = d[Symbol.iterator]);
    i.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function (n, t) {
        ti["[object " + t + "]"] = t.toLowerCase()
    });
    k = function (n) {
        function u(n, t, r, u) {
            var s, w, l, v, d, y, g, p = t && t.ownerDocument,
                a = t ? t.nodeType : 9;
            ...
            if (!u && ((t ? t.ownerDocument || t : c) !== i && b(t), t = t || i, h)) {
                if (a !== 11 && (d = ar.exec(n)))
                    ...
                    } if (e.qsa && !lt[n + " "] && (!o || !o.test(n)) && (a !== 1 || t.nodeName.toLowerCase() !== "object")) {
                    if (g = n, p = t, a === 1 && er.test(n)) {
                        for ((v = t.getAttribute("id")) ? v = v.replace(yi, pi) : t.setAttribute("id", v = f), y = ft(n), w = y.length; w--;) y[w] = "#" + v + " " + pt(y[w]);
                        g = y.join(",");
                        p = ti.test(n) && ri(t.parentNode) || t
                    }
                    try {
            ...
            for (var o, u, r, s = n.length, h = t.relative[n[0].type], c = h || t.relative[" "], i = h ? 1 : 0, l = wt(function (n) {
                ...
                if (u = t.relative[n[i].type]) e = [wt(ui(e), u)];
                    ...
                    if (u = t.filter[n[i].type].apply(null, n[i].matches), u[f]) {
                        ...
                        return fi(i > 1 && ui(e), i > 1 && pt(n.slice(0, i - 1).concat({
                            value: n[i - 2].type === " " ? "*" : ""
            ...
            var f = r.length > 0,
                ...
                o = function (o, s, c, l, a) {
                    ...
                    if (g += p, f && p !== g) {
                        ...
                        if (o) {
                            if (g > 0)
                                while (p--) tt[p] || w[p] || (w[p] = tr.call(l));
                            w = bt(w)
                        }
                        k.apply(l, w);
        ...
        var rt, e, t, st, oi, ft, kt, si, ht, w, ut, b, i, s, h, o, d, ct, et, f = "sizzle" + 1 * new Date,
            ...
            pi = function (n, t) {
                return t ? n === "\0" ? "ļæ½" : n.slice(0, -1) + "\\" + n.charCodeAt(n.length - 1).toString(16) + " " : "\\" + n
            },
            wi = function () {
                b()
            },
        ...
        b = u.setDocument = function (n) {
            ...
            return l === i || l.nodeType !== 9 || !l.documentElement ? i : (i = l, s = i.documentElement, h = !oi(i), c !== i && (u = i.defaultView) && u.top !== u && (u.addEventListener ? u.addEventListener("unload", wi, !1) : u.attachEvent && u.attachEvent("onunload", wi)), e.attributes = a(function (n) {
        ...
        u.attr = function (n, r) {
            ...
            var f = t.attrHandle[r.toLowerCase()],
                u = f && nr.call(t.attrHandle, r.toLowerCase()) ? f(n, r, !h) : undefined;
        ...
        t = u.selectors = {
            ...
            filter: {
                ...
                ATTR: function (n, t, i) {
                    return function (r) {
                        var f = u.attr(r, n);
                        return f == null ? t === "!=" : t ? (f += "", t === "=" ? f === i : t === "!=" ? f !== i : t === "^=" ? i && f.indexOf(i) === 0 : t === "*=" ? i && f.indexOf(i) > -1 : t === "$=" ? i && f.slice(-i.length) === i : t === "~=" ? (" " + f.replace(rr, " ") + " ").indexOf(i) > -1 : t === "|=" ? f === i || f.slice(0, i.length + 1) === i + "-" : !1) : !0
                    }
                },
        ...
        return di.prototype = t.filters = t.pseudos, t.setFilters = new di, ft = u.tokenize = function (n, i) {
            ...
            for (r = n, h = [], c = t.preFilter; r;) {
                (!e || (f = ur.exec(r))) && (f && (r = r.slice(f[0].length) || r), h.push(s = []));
                e = !1;
                (f = fr.exec(r)) && (e = f.shift(), s.push({
                    value: e,
                    type: f[0].replace(at, " ")
                }), r = r.slice(e.length));
    ...
    i.each({
        ...
        contents: function (n) {
            return typeof n.contentDocument != "undefined" ? n.contentDocument : (l(n, "template") && (n = n.content || n), i.merge([], n.childNodes))
        }
    }, function (n, t) {
        i.fn[n] = function (r, u) {
                                ...
                                var h = this,
                                    ...
                                    a = function () {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            u(i) ? e ? i.call(n, s(o, r, ut, e), s(o, r, ri, e)) : (o++, i.call(n, s(o, r, ut, e), s(o, r, ri, e), s(o, r, ut, r.notifyWith))) : (f !== ut && (h = undefined, c = [n]), (e || r.resolveWith)(h, c))
                                        }
                                    },
                                    l = e ? a : function () {
                                        try {
    ...
    var eu = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        pt = new RegExp("^(?:([+-])=|)(" + eu + ")([a-z%]*)$", "i"),
        w = ["Top", "Right", "Bottom", "Left"],
        wt = f.documentElement,
        ft = function (n) {
    ...
    wt.getRootNode && (ft = function (n) {
        return i.contains(n.ownerDocument, n) || n.getRootNode(le) === n.ownerDocument
    });
    bt = function (n, t) {
        return n = t || n, n.style.display === "none" || n.style.display === "" && ft(n) && i.css(n, "display") === "none"
    };
    pi = function (n, t, i, r) {
        var f, u, e = {};
    ...
    i.event = {
        ...
        add: function (n, t, u, f, e) {
            var v, y, w, p, b, h, s, c, o, k, d, l = r.get(n);
            if (l)
                for (u.handler && (v = u, u = v.handler, e = v.selector), e && i.find.matchesSelector(wt, e), u.guid || (u.guid = i.guid++), (p = l.events) || (p = l.events = {}), (y = l.handle) || (y = l.handle = function (t) {
                    ...
                    namespace: k.join(".")
                }, v), (c = p[o]) || (c = p[o] = [], c.delegateCount = 0, s.setup && s.setup.call(n, f, k, y) !== !1 || n.addEventListener && n.addEventListener(o, y)), s.add && (s.add.call(n, h), h.handler.guid || (h.handler.guid = u.guid)), e ? c.splice(c.delegateCount++, 0, h) : c.push(h), i.event.global[o] = !0)
        },
        ...
        special: {
            ...
            click: {
                setup: function (n) {
                    var t = this || n;
                    return kt.test(t.type) && t.click && l(t, "input") && ei(t, "click", ot), !1
                },
                trigger: function (n) {
                    var t = this || n;
    ...
    i.Event = function (n, t) {
        ...
        n && n.type ? (this.originalEvent = n, this.type = n.type, this.isDefaultPrevented = n.defaultPrevented || n.defaultPrevented === undefined && n.returnValue === !1 ? ot : st, this.target = n.target && n.target.nodeType === 3 ? n.target.parentNode : n.target, this.currentTarget = n.currentTarget, this.relatedTarget = n.relatedTarget) : this.type = n;
        t && i.extend(this, t);
    ...
    i.fn.extend({
        ...
        off: function (n, t, r) {
            ...
            return (t === !1 || typeof t == "function") && (r = t, t = undefined), r === !1 && (r = st), this.each(function () {
    ...
    i.extend({
        ...
        clone: function (n, t, r) {
            ...
            if (!e.noCloneChecked && (n.nodeType === 1 || n.nodeType === 11) && !i.isXMLDoc(n))
                for (f = s(h), o = s(n), u = 0, c = o.length; u < c; u++) io(o[u], f[u]);
            if (t)
                if (r)
                    for (o = o || s(n), f = f || s(h), u = 0, c = o.length; u < c; u++) yu(o[u], f[u]);
                else yu(n, h);
            return f = s(h, "script"), f.length > 0 && bi(f, !l && s(n, "script")), h
        },
    ...
    i.fn.extend({
        ...
        html: function (n) {
            return p(this, function (n) {
                ...
                if (typeof n == "string" && !ke.test(n) && !c[(su.exec(n) || ["", ""])[1].toLowerCase()]) {
                    n = i.htmlPrefilter(n);
                    try {
    ...
    (function () {
        function r() {
            if (t) {
                ...
                wt.appendChild(o).appendChild(t);
    ...
    i.extend({
        ...
        style: function (n, t, r, u) {
            if (n && n.nodeType !== 3 && n.nodeType !== 8 && n.style) {
                ...
                if (l || (t = gi(c)), o = i.cssHooks[t] || i.cssHooks[c], r !== undefined) {
                    if (s = typeof r, s === "string" && (f = pt.exec(r)) && f[1] && (r = ou(n, t, f), s = "number"), r == null || r !== r) return;
        ...
        css: function (n, t, r, u) {
            var f, o, e, s = y(t),
                h = gu.test(t);
            return (h || (t = gi(s)), e = i.cssHooks[t] || i.cssHooks[s], e && "get" in e && (f = e.get(n, !0, r)), f === undefined && (f = dt(n, t, u)), f === "normal" && t in nf && (f = nf[t]), r === "" || r) ? (o = parseFloat(f), r === !0 || isFinite(o) ? o || 0 : f) : f
        }
    });
    i.each(["height", "width"], function (n, t) {
        i.cssHooks[t] = {
            get: function (n, r, u) {
                if (r) return fo.test(i.css(n, "display")) && (!n.getClientRects().length || !n.getBoundingClientRect().width) ? pi(n, eo, function () {
                    return rf(n, t, u)
                }) : rf(n, t, u)
            },
            set: function (n, r, u) {
                var s, f = oi(n),
                    ...
                    o = u ? nr(n, t, u, c, f) : 0;
                return c && h && (o -= Math.ceil(n["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(f[t]) - nr(n, t, "border", !1, f) - .5)), o && (s = pt.exec(r)) && (s[3] || "px") !== "px" && (n.style[t] = r, r = i.css(n, t)), tf(n, r, o)
            }
        }
    });
    i.cssHooks.marginLeft = wu(e.reliableMarginLeft, function (n, t) {
        if (t) return (parseFloat(dt(n, "marginLeft")) || n.getBoundingClientRect().left - pi(n, {
            marginLeft: 0
        }, function () {
    ...
    i.each({
        ...
        n !== "margin" && (i.cssHooks[n + t].set = tf)
    });
    i.fn.extend({
        css: function (n, t) {
    ...
    i.Animation = i.extend(v, {
        tweeners: {
            "*": [function (n, t) {
                ...
                return ou(i.elem, n, pt.exec(t), i), i
            }]
        },
        ...
        stop: function (n, t, u) {
            ...
            return typeof n != "string" && (u = t, t = n, n = undefined), t && n !== !1 && this.queue(n || "fx", []), this.each(function () {
                ...
                if (t) e[t] && e[t].stop && f(e[t]);
                    ...
                    for (t in e) e[t] && e[t].stop && ff.test(t) && f(e[t]);
    ...
    i.fx.tick = function () {
        var r, n = 0,
            t = i.timers;
        for (ct = Date.now(); n < t.length; n++) r = t[n], r() || t[n] !== r || t.splice(n--, 1);
        t.length || i.fx.stop();
        ct = undefined
    };
    ...
    i.extend({
        attr: function (n, t, r) {
            ...
            if (e !== 3 && e !== 8 && e !== 2) {
                ...
                if (e === 1 && i.isXMLDoc(n) || (f = i.attrHooks[t.toLowerCase()] || (i.expr.match.bool.test(t) ? sf : undefined)), r !== undefined) {
                    if (r === null) {
                        i.removeAttr(n, t);
                        return
                    }
    ...
    i.each(i.expr.match.bool.source.match(/\w+/g), function (n, t) {
        var r = lt[t] || i.find.attr;
        lt[t] = function (n, t, i) {
            var f, e, u = t.toLowerCase();
            return i || (e = lt[u], lt[u] = f, f = r(n, t, i) != null ? u : null, lt[u] = e), f
        }
    });
    hf = /^(?:input|select|textarea|button)$/i;
    cf = /^(?:a|area)$/i;
    i.fn.extend({
        prop: function (n, t) {
        ...
        propHooks: {
            tabIndex: {
                get: function (n) {
                    ...
                    return t ? parseInt(t, 10) : hf.test(n.nodeName) || cf.test(n.nodeName) && n.href ? 0 : -1
                }
            }
        },
        propFix: {
    ...
    i.fn.extend({
        addClass: function (n) {
            ...
            if (f = ir(n), f.length)
                while (r = this[c++])
                    if (e = nt(r), t = r.nodeType === 1 && " " + g(e) + " ", t) {
        ...
        toggleClass: function (n, t) {
            ...
            return typeof t == "boolean" && e ? t ? this.addClass(n) : this.removeClass(n) : u(n) ? this.each(function (r) {
                ...
                var t, o, u, s;
                if (e)
                    for (o = 0, u = i(this), s = ir(n); t = s[o++];) u.hasClass(t) ? u.removeClass(t) : u.addClass(t);
                else(n === undefined || f === "boolean") && (t = nt(this), t && r.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || n === !1 ? "" : r.get(this, "__className__") || ""))
            })
        },
        hasClass: function (n) {
            for (var t, r = 0, i = " " + n + " "; t = this[r++];)
                if (t.nodeType === 1 && (" " + g(nt(t)) + " ").indexOf(i) > -1) return !0;
            return !1
        }
    });
    lf = /\r/g;
    i.fn.extend({
        val: function (n) {
            ...
            })) : f ? (t = i.valHooks[f.type] || i.valHooks[f.nodeName.toLowerCase()], t && "get" in t && (r = t.get(f, "value")) !== undefined) ? r : (r = f.value, typeof r == "string") ? r.replace(lf, "") : r == null ? "" : r : void 0
        }
    });
    i.extend({
        valHooks: {
    ...
    i.extend(i.event, {
        trigger: function (t, e, o, s) {
            ...
            if ((c = w = l = o = o || f, o.nodeType !== 3 && o.nodeType !== 8) && !rr.test(h + i.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), v = h.indexOf(":") < 0 && "on" + h, t = t[i.expando] ? t : new i.Event(h, typeof t == "object" && t), t.isTrigger = s ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = undefined, t.target || (t.target = o), e = e == null ? [t] : i.makeArray(e, [t]), a = i.event.special[h] || {}, s || !a.trigger || a.trigger.apply(o, e) !== !1)) {
                ...
                for (k = 0;
                    (c = b[k++]) && !t.isPropagationStopped();) w = c, t.type = k > 1 ? d : a.bindType || h, y = (r.get(c, "events") || {})[t.type] && r.get(c, "handle"), y && y.apply(c, e), y = v && c[v], y && y.apply && vt(c) && (t.result = y.apply(c, e), t.result === !1 && t.preventDefault());
                return t.type = h, s || t.isDefaultPrevented() || (!a._default || a._default.apply(b.pop(), e) === !1) && vt(o) && v && u(o[h]) && !tt(o) && (l = o[v], l && (o[v] = null), i.event.triggered = h, t.isPropagationStopped() && w.addEventListener(h, ur), o[h](), t.isPropagationStopped() && w.removeEventListener(h, ur), i.event.triggered = undefined, l && (o[v] = l)), t.result
            }
        },
    ...
    i.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var n = this.type;
                return this.name && !i(this).is(":disabled") && lo.test(this.nodeName) && !co.test(n) && (this.checked || !kt.test(n))
            }).map(function (n, t) {
                var r = i(this).val();
    ...
    return sr.href = gt.href, i.extend({
        ...
        ajax: function (t, r) {
            function b(t, r, f, l) {
                var v, rt, g, p, b, a = r;
                s || (s = !0, d && n.clearTimeout(d), c = undefined, k = l || "", e.readyState = t > 0 ? 4 : 0, v = t >= 200 && t < 300 || t === 304, f && (p = ko(u, e, f)), p = go(u, p, e, v), v ? (u.ifModified && (b = e.getResponseHeader("Last-Modified"), b && (i.lastModified[o] = b), b = e.getResponseHeader("etag"), b && (i.etag[o] = b)), t === 204 || u.type === "HEAD" ? a = "nocontent" : t === 304 ? a = "notmodified" : (a = p.state, rt = p.data, g = p.error, v = !g)) : (g = a, (t || !a) && (a = "error", t < 0 && (t = 0))), e.status = t, e.statusText = (r || a) + "", v ? tt.resolveWith(h, [rt, a, e]) : tt.rejectWith(h, [e, a, g]), e.statusCode(w), w = undefined, y && nt.trigger(v ? "ajaxSuccess" : "ajaxError", [e, u, v ? rt : g]), it.fireWith(h, [e, a]), y && (nt.trigger("ajaxComplete", [e, u]), --i.active || i.event.trigger("ajaxStop")))
            }
            ...
            var c, o, k, v, d, l, s, y, g, p, u = i.ajaxSetup({}, r),
                ...
                e = {
                    ...
                    getResponseHeader: function (n) {
                        ...
                        if (s) {
                            if (!v)
                                for (v = {}; t = po.exec(k);) v[t[1].toLowerCase() + " "] = (v[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = v[n.toLowerCase() + " "]
                        }
            ...
            if (tt.promise(e), u.url = ((t || u.url || gt.href) + "").replace(bo, gt.protocol + "//"), u.type = r.method || r.type || u.method || u.type, u.dataTypes = (u.dataType || "*").toLowerCase().match(a) || [""], u.crossDomain == null) {
                l = f.createElement("a");
                try {
                    l.href = u.url;
                    l.href = l.href;
            ...
            if (u.data && u.processData && typeof u.data != "string" && (u.data = i.param(u.data, u.traditional)), bf(yf, u, r, e), s) return e;
            y = i.event && u.global;
            y && i.active++ == 0 && i.event.trigger("ajaxStart");
            u.type = u.type.toUpperCase();
            u.hasContent = !wo.test(u.type);
            o = u.url.replace(vo, "");
            u.hasContent ? u.data && u.processData && (u.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (u.data = u.data.replace(ao, "+")) : (p = u.url.slice(o.length), u.data && (u.processData || typeof u.data == "string") && (o += (fr.test(o) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (o = o.replace(yo, "$1"), p = (fr.test(o) ? "&" : "?") + "_=" + af++ + p), u.url = o + p);
            ...
            e.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + (u.dataTypes[0] !== "*" ? ", " + pf + "; q=0.01" : "") : u.accepts["*"]);
            for (g in u.headers) e.setRequestHeader(g, u.headers[g]);
            if (u.beforeSend && (u.beforeSend.call(h, e, u) === !1 || s)) return e.abort();
            if (ft = "abort", it.add(u.complete), e.done(u.success), e.fail(u.error), c = bf(or, u, r, e), c) {
        ...
        0: 200,
        1223: 204
    }, at = i.ajaxSettings.xhr(), e.cors = !!at && "withCredentials" in at, e.ajax = at = !!at, i.ajaxTransport(function (t) {
        var i, r;
        if (e.cors || at && !t.crossDomain) return {
            send: function (u, f) {
                var o, e = t.xhr();
                ...
                i = function (n) {
                    return function () {
                        i && (i = r = e.onload = e.onerror = e.onabort = e.ontimeout = e.onreadystatechange = null, n === "abort" ? e.abort() : n === "error" ? typeof e.status != "number" ? f(0, "error") : f(e.status, e.statusText) : f(kf[e.status] || e.status, e.statusText, (e.responseType || "text") !== "text" || typeof e.responseText != "string" ? {
                            binary: e.response
                        } : {
                            text: e.responseText
        ...
        var f, s, h, e = this,
            o = n.indexOf(" ");
        return o > -1 && (f = g(n.slice(o)), n = n.slice(0, o)), u(t) ? (r = t, t = undefined) : t && typeof t == "object" && (s = "POST"), e.length > 0 && i.ajax({
            url: n,
            type: s || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (n, t, r) {
            var o, s, h, c, f, l, y, a = i.css(n, "position"),
                v = i(n),
                e = {};
        ...
        i.fn[n] = function (i) {
            return p(this, function (n, i, u) {
                var f;
                if (tt(n) ? f = n : n.nodeType === 9 && (f = n.defaultView), u === undefined) return f ? f[t] : n[i];
                f ? f.scrollTo(r ? f.pageXOffset : u, r ? u : f.pageYOffset) : n[i] = u
            }, n, i, arguments.length)
        }
    }), i.each(["top", "left"], function (n, t) {
        i.cssHooks[t] = wu(e.pixelPosition, function (n, r) {
        ...
        i.each({
            ...
            i.fn[u] = function (f, e) {
                ...
                return p(this, function (t, r, f) {
                    var e;
                    return tt(t) ? u.indexOf("outer") === 0 ? t["inner" + n] : t.document.documentElement["client" + n] : t.nodeType === 9 ? (e = t.documentElement, Math.max(t.body["scroll" + n], e["scroll" + n], t.body["offset" + n], e["offset" + n], e["client" + n])) : f === undefined ? i.css(t, r, s) : i.style(t, r, f, s)
                }, t, o ? f : undefined, o)
            }
        })
        ...
        var f, e, r;
        return (typeof t == "string" && (f = n[t], t = n, n = f), !u(n)) ? undefined : (e = b.call(arguments, 2), r = function () {
            return n.apply(t || this, e.concat(b.call(arguments)))
        }, r.guid = n.guid = n.guid || i.guid++, r)
    }, i.holdReady = function (n) {
        n ? i.readyWait++ : i.ready(!0)
    }, i.isArray = Array.isArray, i.parseJSON = JSON.parse, i.nodeName = l, i.isFunction = u, i.isWindow = tt, i.camelCase = y, i.type = it, i.now = Date.now, i.isNumeric = function (n) {
        var t = i.type(n);
        return (t === "number" || t === "string") && !isNaN(n - parseFloat(n))
    }, typeof define == "function" && define.amd && define("jquery", [], function () {
        return i
    }), df = n.jQuery, gf = n.$, i.noConflict = function (t) {
        return n.$ === i && (n.$ = gf), t && n.jQuery === i && (n.jQuery = df), i
    }, t || (n.jQuery = n.$ = i), i
});