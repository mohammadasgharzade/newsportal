 ...
 <!--header start-->
  <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="#" class="logo"> فارس <span> </span><span>نیوز </span></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <p class="red">شما 0 پیام جدید دارید</p>
                            </li>
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{url('/admin_template/img/avatar-mini.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{url('/admin_template/img/avatar-mini2.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{url('/admin_template/img/avatar-mini3.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{url('/admin_template/img/avatar-mini4.jpg')}}"></span>
                                    <span class="subject">
                    ...
                    <li id="header_notification_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended notification">
                            ...
                            <li>
                                <p class="yellow">شما 0 اعلام جدید دارید</p>
                            </li>
                            <li>
                                <a href="#">
            ...
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="{{url('admin/user/profile')}}">
                        <img alt="" src="{{asset(auth()->user()->avatar)}}" style="width: 30px; height: 30px;">     
                           <span class="username">{{Auth::user()->name}} </span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu extended logout">
                            <div class="log-arrow-up"></div>
                            <li><a href="{{url('/admin/user/profile')}}"><i class=" icon-suitcase"></i>پروفایل</a></li>
                            <li><a href="{{url('admin/setting')}}"><i class="icon-cog"></i> تنظیمات</a></li>
