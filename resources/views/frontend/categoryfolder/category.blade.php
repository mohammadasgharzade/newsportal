                ...
                <div class="col-12 float-right">
                    ...
                    <div class="row">
                        <div class="col-12 px-0">
                            ...
                            @foreach($category->posts()->orderby('id','DESC')->get() as $key=>$item)
                            @if($key == 0)
                            <div class="top-news d-flex flex-wrap w-100 mb-2">
                                ...
                                @foreach($category->posts()->orderby('id','DESC')->get() as $key=>$item)
                                @if($key > 0 && $key < 7) 
                                <div  class="news-list float-right mb-2 d-flex top-news-middle padding-normal col-12 col-md-4 col-lg-3 ">
                                    <div class="w-100 d-flex d-md-inline-block">
                                        <a class="w-100 col-5 col-md-12 px-0 d-flex align-items-center"
                                            ...
                                            <img class="w-100" src="{{asset($item->cover)}}" alt="{{$item->title}}" style="height: 200px;">
                                        </a>
                                        <div class="p-3 text d-flex flex-column justify-content-center justify-content-md-between">
                    ...
                    <div class="d-flex flex-wrap w-100 col-12 mb-3 padding-normal">
                        <div class="last-news w-100 mb-2">
                            ...
                            <ul class="news-list list-unstyled p-0 m-0">
                                ...
                                @foreach($category->images->take(20) as $key=>$item)
                ...
                <div class="row padding-normal  pb-3">
                    ...
                    <aside class=" d-none d-lg-block">
                        ...
                        <a href="{{$item->url}}" target="_blank">
                            <img class="w-100 mt-3" src="{{asset($item->image)}}" alt="">
                        </a>
                            ...
                            <div class="content">
                                ...
                                <ul class="list-unstyled m-0 p-0">
                                    <li class=" d-flex align-items-center px-3 py-2 border-bottom align-items-center">
                                        ...
                                        <h3> <a class="text-justify d-flex"
