...
<div class="row">
    ...
    <div class="col-sm-4 cat-form">
        ...
        <h3 style="color: inherit;"> ویرایش مجموعه </h3>
        <form method="post" action="{{route('updatecategory',$singledata->id)}}">
            @csrf             
            ...
            <div class="form-group">
			<label>اسلاگ</label>
            <input type="text" id="slug" name="slug" class="form-control" placeholder="اسلاگ" value="{{$singledata->title}}" readonly>
           </div>
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary pull-right" value=" بروزرسانی ">
            </div>
